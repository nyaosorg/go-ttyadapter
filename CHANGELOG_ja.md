...
- tty8, tty8pe: EAGAIN/EWOULDBLOCK エラーの際にリトライする処理を追加した。go-tty v0.0.8 から、端末のファイルディスクリプタにノンブロッキングモードが設定され、キー読み込みの際、ブロックするかわりに EAGAIN エラーが返されるようになった。この変更で go-tty の特定バージョンによらずにそういったエラーに耐えらえるようになったはず (#21)
